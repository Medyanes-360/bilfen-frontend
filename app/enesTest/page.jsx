...
export default function Home() {
  ...
  const handleDaySelect = (day) => {
    setSelectedDay(day);
    // Gerçek uygulamada burada seçilen güne göre içerik yüklenecek
  };
            ...
            <header className="bg-gradient-to-r from-orange-400 to-orange-600 text-white p-5 md:p-6 rounded-b-3xl md:rounded-none relative overflow-hidden">
              ...
              <div className="relative z-10 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold flex items-center gap-2">
                    {userData.name} <span className="transition-transform hover:scale-125 inline-block">{userData.emoji}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-5 relative z-10">
                <div className="flex justify-between mb-2 text-sm">
                  ...
                  <div className="font-bold">{completedTasks}/{totalTasks} görev</div>
                </div>
                <div className="h-8 bg-white/20 rounded-full overflow-hidden relative backdrop-blur-sm">
                      ...
                      <div 
                        ...
                        className={`h-full flex-1 ${
                          index < completedTasks 
                            ...
                            : 'bg-transparent'
                        } ${index < completedTasks - 1 ? '' : 'rounded-r-full'}`}
                        style={{ opacity: index < completedTasks ? (1 - (index * 0.1)) : 0 }}
                      >
                        {index < completedTasks && (
                  ...
                  {/* Progress Star */}
                  <div className="absolute top-1/2 z-10 flex items-center justify-center"
                    style={{ 
                      ...
                      >
                        ...
                        `}>
                          ...
                          <div className="flex justify-between items-center">
                            <div className="bg-orange-50 text-orange-600 py-1 px-3 rounded-full text-xs font-bold flex items-center gap-1 transition-all hover:bg-orange-100">
                              ⭐ {task.completed ? `${task.points} puan kazandın` : `${task.points} puan kazanacaksın`}
                            </div>
                    ...
                    {recommendations.map((item) => (
                      ...
                      >
                        ...
                        <div 
                          ...
                          `}
                        >
                          <span className="relative z-10 transform transition-transform group-hover:scale-125">{item.contentIcon}</span>
          ...
          <div className="hidden lg:block lg:w-1/4 p-6">
            <div className="sticky top-4">
              ...
              <div className="bg-gray-50 p-4 rounded-xl mb-6 border border-gray-200 transition-all hover:shadow-md hover:bg-gray-50/80">
                <p className="text-gray-700 text-sm mb-3">Her gün 30 dakika okuma yaparak haftalık okuma hedefine ulaşabilirsin!</p>
                <div className="bg-orange-100 text-orange-600 p-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-transform hover:scale-[1.01]">
                  <span className="text-xl transition-transform hover:scale-110">💡</span> İpuçlarını takip et, daha hızlı ilerle!
                </div>
              </div>
