            ...
            <ul className="space-y-4 uppercase font-poppins font-semibold text-darklila">
                ...
                <Collapsible>
                  ...
                  <CollapsibleContent>
                    <ul className="pl-4 pt-2 space-y-2">
                      <li><Link href="/soft-play" className="block py-1 text-sm">Home #1 - Soft Play Area</Link></li>
                      <li><Link href="/birthday-party" className="block py-1 text-sm">Home #2 - Birthday Party</Link></li>
                      <li><Link href="/child-care" className="block py-1 text-sm">Home #3 - Child Care Center</Link></li>
                      <li><Link href="/home-boxed" className="block py-1 text-sm">Home Boxed</Link></li>
                    </ul>
                  </CollapsibleContent>
                </Collapsible>
              </li>
              ...
              {Object.entries(menuItems).map(([key, items]) => (
                <li key={key}>
                  <Collapsible>
                    <div className="flex items-center justify-between">
                      <Link href={`/${key}`} className="py-2">{key.toUpperCase()}</Link>
                      <CollapsibleTrigger asChild>
                        <Button variant="ghost" size="sm" className="p-0 hover:bg-transparent">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <polyline points="6 9 12 15 18 9"></polyline>
              ...
              <li>
                <Link href="/contacts" className="block py-2">CONTACTS</Link>
              </li>
            </ul>
          </div>
