...
export default function ArchiveButton({ onClick }) {
  return (
    <div className="mb-8">
      <button
        onClick={onClick}
        className="cursor-pointer w-full bg-white border-2 border-gray-200 hover:border-orange-200 rounded-xl px-5 py-4 flex items-center justify-between transition-all duration-200 shadow-md hover:shadow-lg hover:bg-orange-50/50"
      >
