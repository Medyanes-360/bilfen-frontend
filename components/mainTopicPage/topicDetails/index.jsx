    ...
    <div className="flex flex-col h-full min-h-[550px]">
      ...
      <div className="flex-1 overflow-auto space-y-4">
        <div className="min-h-[400px] flex flex-col space-y-4">
          {paginatedTopics.map((subTopic, index) => (
            <div
              key={subTopic.id}
              className="flex gap-2 md:gap-3 lg:gap-4 items-start border border-tertiary-50 bg-white py-6 px-2 md:px-4 rounded-lg shadow-md"
            >
              {/* Sıra Numarası */}
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center gap-4 pt-6 mt-6 border-t border-gray-100">
          <button
            className="cursor-pointer text-sm px-4 py-2 rounded-md border transition-all duration-200 bg-tertiary-400 hover:bg-tertiary-500 text-white disabled:bg-gray-100 disabled:opacity-50 disabled:text-black disabled:cursor-default"
