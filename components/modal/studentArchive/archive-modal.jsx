...
export default function ArchiveModal({ onClose, materials, isMobile }) {
  ...
  const handleMaterialClick = (material) => {
    const isVideo =
      material.type === "video" ||
      (material.content &&
        (material.content.endsWith(".mp4") ||
          material.content.endsWith(".webm") ||
          material.content.endsWith(".mov")));
      ...
      >
        <div className="flex items-center justify-between p-5 border-b">
          <h2 className="text-xl font-semibold flex items-center gap-3">
            <span className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center text-xl">
              🗄️
            </span>
            Arşiv
          </h2>
              ...
              filteredMaterials.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-gray-400">
                  ...
                  <p className="text-center italic">
                    Bu tarih için materyal bulunmamaktadır.
                  </p>
                </div>
              )
            ) : (
